...
const Will = new Person({name: 'Will',age:32,favoriteFoods:['pizza','pizza','burgers']});
...
var createAndSavePerson = function(done) {
  var Will = new Person({name: 'Will',age:32,favoriteFoods:['pizza','pizza','burgers']});
  console.log(Will)
  console.log(mongoose._readyState)
  Will.save(function(err, data){
...
var arrayOfPeople = [
  {name:'Will',age:32,favoriteFoods:['pizza','tacos','burritos']},
  {name:'Meg',age:35,favoriteFoods:['vape','salad','tuna']},
  {name:"lenore",age:11,favoriteFoods:['olivegarden','modpizza','pandaexpress']}
];
...
var findPersonById = function(personId, done) {
  Person.findById({_id:personId},function(err,res){
    if (err) return console.log(err);
    done(null, res)
  })  
};
