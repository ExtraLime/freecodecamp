...
suite('Functional Tests', function() {
  ...
  suite('Integration tests with chai-http', function() {
    ...
    suite('GET /hello?name=[name] => "hello [name]"', function(){
      ...
      test('Test GET /hello with your name',  function(done){ // Don't forget the callback...
         chai.request(server)             // 'server' is the Express App
          .get('/hello?name=will') /** <=== Put your name in the query **/ 
          .end(function(err, res){        // res is the response object
            ...
            assert.equal(res.status, 200);
             assert.equal(res.text, 'hello will'/** <==  Put your name here **/);
            done();   // Always call the 'done()' callback when finished.
          });
      });
    ...
    suite('PUT /travellers', function(){
      ...
      test('send {surname: "Colombo"}',  function(done){
       ...
       chai.request(server)
        ...
        .end(function(err, res){
          ...
          /** your tests here **/
          assert.equal(res.status,200);
         assert.equal(res.type, 'application/json'); // remove this after adding tests
          assert.equal(res.body.name, 'Cristoforo');
            assert.equal(res.body.surname, 'Colombo');
         //assert.equal(res.dates, '1451-1506')
      ...
      test('send {surname: "da Verrazzano"}', function(done) {
        ...
        chai.request(server).put('/travellers')
  ...
  Browser.site = 'https://adventurous-snowy-birth.glitch.me'; 
    ...
    suite('"Famous Italian Explorers" form', function() {
      ...
      test('submit "surname" : "Colombo" - write your e2e test...', function(done) {
        ...
        browser
          ...
          .pressButton('submit', function(){
            browser.assert.success();
            browser.assert.text('span#name','Cristoforo')// assert that the text inside the element 'span#name' is 'Cristoforo'
